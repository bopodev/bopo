...
function NavigationMenu({
  ...
  return (
    <NavigationMenuPrimitive.Root
      ...
      className={cn("ui-navigation-menu", className)}
      {...props}
    >
      {children}
...
function NavigationMenuTrigger({
  ...
  return (
    <NavigationMenuPrimitive.Trigger
      ...
      className={cn(navigationMenuTriggerStyle(), "ui-navigation-menu-trigger-group", className)}
      {...props}
    >
      {children}{" "}
      <ChevronDownIcon
        className="ui-navigation-menu-trigger-icon"
        aria-hidden="true"
      />
    </NavigationMenuPrimitive.Trigger>
  )
...
function NavigationMenuViewport({
  ...
  return (
    <div className={cn("ui-navigation-menu-viewport-wrapper")}>
...
function NavigationMenuIndicator({
  ...
  return (
    <NavigationMenuPrimitive.Indicator
      ...
      {...props}
    >
      <div className="ui-navigation-menu-indicator-tip" />
    </NavigationMenuPrimitive.Indicator>
  )
}
