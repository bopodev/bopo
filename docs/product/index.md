...
Use this section if you are operating Bopo as a company control plane.

## Audience

- Founders, engineering managers, and operators running agent teams.
- Anyone responsible for projects, issue flow, approvals, and execution quality.
...
- [`agents-and-runs.md`](./agents-and-runs.md): hiring/configuring agents, **Documents** (operating + memory markdown), and running heartbeats safely.
- [`routines.md`](./routines.md): scheduled recurring work (routines) vs agent heartbeats.
